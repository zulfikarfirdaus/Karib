...
import { tanyaJawabDetailQuery, allTanyaJawabQuery } from "@/lib/queries";
...
const getTanyaJawab = cache((slug: string) =>
  safeFetch(tanyaJawabDetailQuery, { slug })
);
...
export default async function TanyaJawabDetailPage({ params }: TanyaJawabDetailPageProps) {
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      ...
      {/* Tanya Karib */}
      <div className="mt-16 max-w-[680px] mx-auto bg-white dark:bg-card rounded-2xl px-8 py-10">
        <div className="mb-6">
